...
#genes <- c("Age", "Sex", "GRAD", "pT", "BACE1", "CD40LG", "CD2BP2", "TRIP10", "ZNF785", "SUM01_low", "combi18_1", "combi15_14")
...
#res.cox <- coxph(Surv(RFS, RFS01) ~ BACE1 + CD40LG + CD2BP2 + TRIP10 + ZNF785 + SUM01_low + combi18_1 + combi15_14 + Age + Sex + GRAD + pT, data = surv_cat)
